...
namespace Messenger.Migrations
{
    ...
    [Migration("20211115114221_AlterInGroup")]
    partial class AlterInGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Messenger.Entities.Bookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Messenger.Entities.Group", b =>
                {
            ...
            modelBuilder.Entity("Messenger.Entities.GroupUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Messenger.Entities.UserType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Messenger.Entities.GroupUsers", b =>
                {
                    b.HasOne("Messenger.Entities.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("Messenger.Entities.Message", b =>
                {
                    b.HasOne("Messenger.Entities.ContentType", "ContentType")
                        .WithMany()
                        .HasForeignKey("ContentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Messenger.Entities.User", "ForwardedFromUser")
                        .WithMany()
                        .HasForeignKey("ForwardedFromId");

                    b.HasOne("Messenger.Entities.Reaction", "Reaction")
                        .WithMany()
            ...
            modelBuilder.Entity("Messenger.Entities.User", b =>
                {
                    b.HasOne("Messenger.Entities.UserType", "UserType")
                        .WithMany()
