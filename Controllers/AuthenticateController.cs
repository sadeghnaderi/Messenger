...
namespace Messenger.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public AuthenticateController(MessengerDbContext messengerDbContext, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel model)
        {
            ...
            _MessengerDbContext.User.Add(NewUserInfo);
